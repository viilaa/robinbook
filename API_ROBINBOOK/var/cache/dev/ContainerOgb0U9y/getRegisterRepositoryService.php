 ...
 */
class getRegisterRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RegisterRepository' shared autowired service.
     *
     * @return \App\Repository\RegisterRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RegisterRepository.php';

        return $container->privates['App\\Repository\\RegisterRepository'] = new \App\Repository\RegisterRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
